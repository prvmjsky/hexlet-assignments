...
public class ProductsController {
    ...
    @GetMapping
    public List<ProductDTO> index(ProductParamsDTO params, @RequestParam(defaultValue = "1") Integer pageNum) {
        var spec = productSpecification.build(params);
        var products = productRepository.findAll(spec, PageRequest.of(pageNum - 1, 10));
